...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TransactionFailedToLogException.class)
    public ResponseEntity<?> transactionFailedToLogException(TransactionFailedToLogException ex, WebRequest request){
    	ErrorDetails errorDetails = new ErrorDetails(new Date(), ex.getMessage(), request.getDescription(false));
